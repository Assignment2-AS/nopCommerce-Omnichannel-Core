...
echo "[demo] Injecting WMS fault: 10s delay + 503 on all GET /api/stock/* calls..."
...
if [ "$http_code" = "201" ]; then
  ...
  echo "[demo]   Each WMS call blocks for 10s before failing — triggers timeout policy in OrderSyncAdapter"
else
